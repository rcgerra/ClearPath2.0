...
export default function TeamDemandChart({ weeks, series, availability, selectedId, onSelect, height = 240, palette = PALETTE, alertThreshold }: Props) {
  ...
  const peak = Math.max(1, ...totals, ...availability.slice(0, weeks), alertThreshold ?? 0);
